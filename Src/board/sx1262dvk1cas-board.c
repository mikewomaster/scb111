...
extern RadioError_t deviceErrorRegs;
extern RadioStatus_t statusRegs;
...
void SX126xIoInit( void )
{
    ...
    //GpioInit( &DeviceSel, RADIO_DEVICE_SEL, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
		GpioInit( &SX126x.RXEN, RADIO_RXEN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );
		GpioInit( &SX126x.TXEN, RADIO_TXEN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
}
