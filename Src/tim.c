...
/* TIM3 init function */
void MX_TIM3_Init(uint16_t freq, uint16_t duty)
{
  ...
  sConfigOC.Pulse = duty*10000/freq;
...
/* TIM22 init function */
void MX_TIM22_Init(uint16_t freq, uint16_t duty)
{
  TIM_MasterConfigTypeDef sMasterConfig = {0};
  TIM_OC_InitTypeDef sConfigOC = {0};
  ...
  htim22.Init.Period = (1000000/freq)-1;
